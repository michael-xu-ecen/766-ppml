...
```shell
python DPFLAttack.py --dataset mnist --iid --model cnn --epochs 50 --dp_mechanism no_dp
```
### 高斯机制
...
```shell
python DPFLAttack.py --dataset mnist --model cnn --epochs 50 --dp_mechanism Gaussian --dp_epsilon 10 --dp_delta 1e-5 --dp_clip 10
```
...
```shell
python DPFLAttack.py --dataset mnist --model cnn --dp_mechanism MA --dp_epsilon 10 --dp_delta 1e-5 --dp_clip 10 --dp_sample 0.01
```
以下论文可以提供更多信息。
...
```shell
python DPFLAttack.py --dataset mnist --model cnn --epochs 50 --dp_mechanism Laplace --dp_epsilon 30 --dp_clip 50
```
