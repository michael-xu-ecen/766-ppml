...
```shell
python DPFLAttack.py --dataset mnist --model cnn --dp_mechanism no_dp
```
### Gaussian Mechanism
...
```shell
python DPFLAttack.py --dataset mnist --model cnn --dp_mechanism Gaussian --dp_epsilon 10 --dp_delta 1e-5 --dp_clip 10
```
...
```shell
python DPFLAttack.py --dataset mnist --model cnn --dp_mechanism Laplace --dp_epsilon 30 --dp_clip 50
```
